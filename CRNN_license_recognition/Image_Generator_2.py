...
class TextImageGenerator:
    def __init__(self, img_folder_dirpath, img_w, img_h,
        ...
        self.img_folder_dirpath = img_folder_dirpath                  # image folder dir path

        self.folders_list = sorted(os.listdir(self.img_folder_dirpath)) # list_tat_ca_folder_bien_so
        #------------------------------------
        self.img_dir = []
        self.img_label = []
        for bien_so_folder in self.folders_list:
            img_list = os.listdir(os.path.join(self.img_folder_dirpath,bien_so_folder))
            for img_name in img_list:
                img_path = self.img_folder_dirpath + bien_so_folder + '/' + img_name
                self.img_dir.append(img_path)
                self.img_label.append(bien_so_folder)
    ...
    def build_data(self):
        ...
        for i, img_file in enumerate(self.img_dir):
            ...
            self.imgs[i, :, :] = img
            self.texts.append(self.img_label[i])
