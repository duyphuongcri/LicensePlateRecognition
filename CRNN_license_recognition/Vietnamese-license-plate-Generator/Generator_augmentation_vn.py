...
class ImageGenerator:
    ...
    def Type_6(self, num, save=False):
            ...
            for i, Iter in enumerate(range(num)):
                ...
                random_width = random.randint(140, 230)
                random_height = random.randint(495, 664)
                random_R, random_G, random_B = random.randint(0,255), random.randint(0,255), random.randint(0,255)
                # print(random_R, random_G, random_B)
                background = np.zeros((random_width, random_height, 3), np.uint8)
                ...
                # print(random_width)
                # print(random_w)
                random_h = random.randint(0, random_height - 464)
                # print(random_height)
                # print(random_h)
                background[random_w:110 + random_w, random_h:464 + random_h, :] = Plate
                background = image_augmentation(background)
    ...
    def Type_2(self, num, save=False):
        ...
        for i, Iter in enumerate(range(num)):
            ...
            random_width = random.randint(220, 310)
            random_height = random.randint(330, 469)
            random_R, random_G, random_B = random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)
            background = np.zeros((random_width, random_height, 3), np.uint8)
            cv2.rectangle(background, (0, 0), (random_height, random_width), (random_R, random_G, random_B), -1)            
           ...
           # number 5
            ...
            s_width, s_height = int((random_width - 190) / 2), int((random_height - 269) / 2)
...
parser.add_argument("-i", "--img_dir", help="save image directory",
                    type=str, default="/home/truongdongdo/Desktop/CRNN-Keras/DB/aug/test_1/")
